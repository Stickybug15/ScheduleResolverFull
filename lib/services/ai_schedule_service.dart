...
class AiScheduleService extends ChangeNotifier {
  ...
  ScheduleAnalysis _parseResponse(String fullText){
    String conflicts = "",recommendedSchedule = "", rankedTask = "", explanation = "";
    ...
    for(var section in sections){
      ...
      else if(section.startsWith('Ranked Task')) rankedTask = section.replaceFirst('Ranked Tasks', "").trim();
      else if(section.startsWith('Recommended Schedule')) recommendedSchedule = section.replaceFirst('Recommended Scheduler', "").trim();
      else if(section.startsWith('Explanation')) explanation = section.replaceFirst('Recommended Scheduler', "").trim();
    }
